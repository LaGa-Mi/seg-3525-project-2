        ...
        <div className="mx-5 justify-content-center align-items-center bg-tertiary" style={show ? {width:"20rem", display:"flex"} : {width:"15rem", display:"none"}}>
            <div className="d-flex flex-column" style={{height:"100%", width:"100%"}}>
                ...
                <div style={{height:"8rem", position:"relative"}}>
                    <img src={props.image} style={props.isVideo ? {height:"100%", width:"100%", objectFit:"cover", filter: "brightness(25%)"} : {height:"100%", width:"100%", objectFit:"cover", zIndex:"-1"}}></img>
                    {props.isVideo ? <img src={require("../../resources/vid.png")} style={{position:"absolute", top:"0", left:"50%", height:"50%", objectFit:"contain", transform:"translate(-50%, 50%)"}}></img> : ""}
                </div>
